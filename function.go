...
func readOrgcode(kdOrg string) (jurusan Jurusan) {
	data := map[string]Jurusan{
		...
		"55.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Kedokteran Keluarga Layanan Primer (Primary Care and Family Medicine)",
			Program:      "Spesialis 1 (Specialist Program)",
		},
		"56.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Orthopaedi dan Traumatologi (Orthopaedic and Traumatology Surgery)",
			Program:      "Spesialis 2 (Sub Specialist Program)",
		},
		"57.00.01.01": {
			Faculty:      "Kedokteran",
		...
		"58.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Pendidikan Dokter Spesialis Kedokteran Emergensi (Emergency Medicine)",
			Program:      "Spesialis 1 (Specialist Program)",
		},
		"59.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Jantung dan Pembuluh Darah (Cardiovascular Medicine)",
			Program:      "Spesialis 2 (Sub Specialist Program)",
		},
		"60.00.01.01": {
			Faculty:      "Kedokteran",
		...
		"61.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Dermatologi Venereologi dan Estetika (Dermatology Venereology & Aesthetic)",
			Program:      "Spesialis 2",
		},
		"62.00.01.01": {
			Faculty:      "Kedokteran",
			ShortFaculty: "FK",
			Major:        "Neurologi (Neurology)",
			Program:      "Spesialis 2",
		},
		"03.00.01.01": {
			Faculty:      "Kedokteran",
